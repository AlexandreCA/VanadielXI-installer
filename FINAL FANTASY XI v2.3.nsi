...
Section "XIInstaller" XIInstaller
  ...
  ${If} $FrenchTranslation == "yes"
    ...
    Goto lang_done
    lang_missing:
      MessageBox MB_OK|MB_ICONSTOP "Error: lang.pak not found in $EXEDIR! French translation not installed."
    lang_done:
  ${Else}
  ...
  ${If} $InstallHDTextures == "yes"
    ...
    Goto hd_done
    hd_missing:
      MessageBox MB_OK|MB_ICONSTOP "Error: hd_textures.pak not found in $EXEDIR! HD textures not installed."
    hd_done:
  ${Else}
